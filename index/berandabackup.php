...
<html lang="en">
  ...
  <body class="">
    ...
    <div class="main-panel">
      ...
      $no = $row1['skbb'] + $row2['sktm'] + $row3['sku'] + $row4['skmd'] ;
      // var_dump($no); exit();
      ?>
      <div class="content">
            ...
            <div class="col-md-12">
              <!-- <div class="card">
                ...
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Seluruh Jenis Surat</p>
                  
                  <h5 class="card-title "><small>Total</small> <?php echo $no ?>
                  <small>Surat</small>
                  </h5>
                </div>
                </center>
          ...
          <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="card card-stats">
              <div class="card-header card-header-info card-header-icon">
                ...
                <h3 class="card-title"><?php include "../proses/countskbb.php"; ?>
                <small>Surat</small>
                </h3>
              </div>
              <div class="card-footer">
                <div class="stats">
                  ...
                  <a href="seluruhsurat.php">Lebih Selengkapnya</a>
                </div>
              </div>
            </div>
          </div>
          <!-- <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
              ...
              <div class="card-footer">
                <div class="stats">
                  <i class="material-icons text-danger"></i>
                  <a href="skbbdetail.php">Lebih Selengkapnya</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
              <div class="card-header card-header-info card-header-icon">
                ...
                <p class="card-category">SKMD</p>
                <h3 class="card-title"><?php include "../proses/countskmd.php"; ?>
                <small>Surat</small>
                </h3>
              </div>
              <div class="card-footer">
                <div class="stats">
                  <i class="material-icons text-danger"></i>
                  <a href="skmddetail.php">Lebih Selengkapnya</a>
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
              <div class="card-header card-header-info card-header-icon">
                ...
                <h3 class="card-title"><?php include "../proses/countsktm.php"; ?>
                <small>Surat</small>
                </h3>
              </div>
              <div class="card-footer">
                <div class="stats">
                  <i class="material-icons text-danger"></i>
                  <a href="sktmdetail.php">Lebih Selengkapnya</a>
                </div>
              </div>
            </div>
          </div> -->
          <!-- <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats">
              <div class="card-header card-header-info card-header-icon">
                ...
                <h3 class="card-title"><?php include "../proses/countsku.php"; ?>
                <small>Surat</small>
                </h3>
              </div>
              <div class="card-footer">
                <div class="stats">
                  <i class="material-icons text-danger"></i>
                  <a href="skudetail.php">Lebih Selengkapnya</a>
                </div>
              </div>
            </div>
          </div> -->
