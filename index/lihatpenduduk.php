          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <select class="selectpicker form-control" id="nik" data-container="body" data-live-search="true" title="Search" data-hide-disabled="true">
                      <option value="0">Unknown</option>
                        <?php                
                        include ('koneksi.php');
                            $sql_d=pg_query("SELECT nik, nama_lgkp FROM pendudukkotogadang ORDER BY nama_lgkp");
                            while($row = pg_fetch_assoc($sql_d))
                            {
                                echo"<option value=".$row['nik'].">(".$row['nik'].") ".$row['nama_lgkp']."</option>";
                            }
                        ?>
                  </select>
                  <form>
                    ...
                    <center >
                      <div class="tampil" >
                        <a  class="btn btn-primary btn-round" value="Tampil" >GO</a>
                      </div>
                    </center>
                                      ...
                                      <div class="card-body table-responsive">
                                        <table  class="table " style="width:100%">
                                          <tbody>
                                            ...
                                            <tr>
                                              <td>NIK</td>
                                              <td>1306051109970000</td>
                                            </tr>
                                            <tr>
                                              <td>No.KK</td>
                                              <td>1306052402085880</td>
                                            </tr>
                                            <tr>
                                              <td>Jenis Kelamin</td>
                                              <td>Laki-Laki</td>
