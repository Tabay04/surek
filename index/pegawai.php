...
<body class="">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="../proses/tambahpegawai.php" method="POST">
                    <div class="row">
                      <div class="col-md-4">
                      </div>
                      <div class="col-md-4">
                          <div class="form-group">
                            <label class="bmd-label-floating">Nomor Pegawai</label>
                            <input id='no_pegawai' required type="text" name="id_pegawai" class="form-control">
                          </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input id='nama_pegawai' required type="text" name="nama_pegawai" class="form-control">
                          </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-4">
                          <div class="form-group">
                            ...
                            <input id='jabatan' required type="text" name="jabatan" class="form-control">
                          </div>
                      </div>
                    </div>
                      <center>
                        <input class="btn btn-primary btn-round" type="submit" name="tambahpegawai" value="Tambah">
                          ...
                          include '../controller/connect.php';
                              ...
                              while($pegawai = pg_fetch_array($query)){
                                  echo "<tr>";
                                    ...
                                    echo "<td> <center>".$pegawai['id_pegawai']."</td>";
                                    echo "<td> <center>".$pegawai['nama_pegawai']."</td>";
                                    echo "<td> <center>".$pegawai['jabatan']."</td>";
                                    echo "<td> <center>";
                                     echo 
                                  '<button type="button" rel="tooltip" title="Edit" class="btn btn-primary btn-link btn-sm edit" data-toggle="modal" data-target="#edit" data-id="'.$pegawai['id_pegawai']."-".$pegawai['nama_pegawai']."-".$pegawai['jabatan'].'">
                                                ...
                                                <div class="row">
                                                  <div class="col-md-12">
                                                    <div class="card">
                                                      <div class="card-header card-header-primary">
                                                          <h4 class="card-title">Pegawai</h4>
                                                          <p class="card-category">Edit Nama Pegawai</p>
                                                        </div>  
                                                      <div class="card-body">
                                                        <form action="../proses/editpegawai.php" method="POST">
                                                          <div class="row">
                                                            ...
                                                            <div class="col-md-10">
                                                              <div class="form-group">
                                                                <label class="bmd-label-floating">Nomor Pegawai</label>
                                                                <input id="id_pgw" required type="text" name="id_pgw" class="form-control" value="">
                                                              </div>
                                                            </div>
                                                          </div>
                                                          <div class="row">
                                                            ...
                                                            <div class="col-md-10">
                                                              <div class="form-group">
                                                                <label class="bmd-label-floating">Nama Pegawai</label>
                                                                <input id="nama_pgw" required type="text" name="nama_pgw" class="form-control" value="">
                                                              </div>
                                                            </div>
                                                          </div>
                                                          <div class="row">
                                                            ...
                                                            <div class="col-md-10">
                                                              <div class="form-group">
                                                                <label class="bmd-label-floating">Jabatan</label>
                                                                <input id="jabatan" required type="text" name="jabatan" class="form-control" value="">
                                                              </div>
                                                            </div>
                                                          </div>
                                  ...
                                  echo 
                                  '<button type="button" rel="tooltip" title="Hapus" class="btn btn-danger btn-link btn-sm hapus" data-toggle="modal" data-target=" #hapus" data-id="'.$pegawai['id_pegawai'].'" >
                                    ...
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        <div class="modal-header">
                                          ...
                                          <button class="close" type="submit" data-dismiss="modal" aria-label="Close" href="../proses/hapuspegawai.php?id='.$pegawai['id_pegawai'].'>
                                        ...
                                        <div class="modal-footer">
                                          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                          <a id="id_pgw" href="../proses/hapuspegawai.php?id='.$pegawai['id_pegawai'].'">
  ...
  <script>
    ...
    var id_pegawai = $(this).data('id').split("-")[0];
    var nama_pegawai = $(this).data('id').split("-")[1];
    var jabatan = $(this).data('id').split("-")[2];
    $("#edit #id_pgw").val(id_pegawai);
    $("#edit #nama_pgw").val(nama_pegawai);
  ...
  <script>
    ...
    $("#hapus #id_pgw").attr("href", "../proses/hapuspegawai.php?id="+id_pegawai);
    $('#hapus').modal('show');
      });
  </script>
  <script>
