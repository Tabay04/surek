    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="suratmenyurat.php">Jenis Surat Baru</a>
          </div>
      ...
      <div class="content">
        <div id="container_logic">
          <div id="pilihan">
            <select id="data" class="data form form-control text-primary">
              <option value="">
                --Pilih Kriteria--
              </option>
              <option value="header">
        ...
        <br>
        <button class="btn btn-primary" onclick="stringBuilder()">Submit</button>
      </div>
    </div>
  <!--   Core JS Files   -->
