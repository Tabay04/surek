      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="listpenduduk.php">
                ...
                <div class="card-body">
                  ...
                  <table id="example" class="table table-bordered" style="width:100%">
                    ...
                    <tbody>
                      <?php
                        include '../controller/connect.php';
                        $result = pg_query($conn,"SELECT * FROM penduduk where no_kk!='0'" );
                        while ($row=pg_fetch_assoc($result)) {
                          ...
                          echo "<td>".$row['nama_lengkap_ibu']."</td>";
                          echo "<td>".$row['nama_lengkap_ayah']."</td>";
                          echo "<td>".$row['status_kawin']."</td>";
                          echo "<td>".$row['gol_darah']."</td>";
                          echo "<td>".$row['pendidikan_akhir']."</td>";
                          echo "<td>".$row['jenis_pekerjaan']."</td>";
                          echo "<td>".$row['status_hubkel']."</td>";
                          echo "<td>".$row['tanggal_entri']."</td>";
                          echo "<td>".$row['tanggal_ubah']."</td>";
