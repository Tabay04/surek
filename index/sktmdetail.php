                        ...
                        <tbody>
                          <?php
                            ...
                            while ($data=pg_fetch_assoc($sql)) {
                                ...
                                echo '<td><center> <a class="material-icons" target="_blank" href="../surat/sktm/sktm.php?no='.$data['no_surat'].'">insert_drive_file</a>
                                    
                                 </center></td>';

                                echo "</tr>";
                                // <a class="material-icons" target="_blank" href="../surat/sktm/sktm.php?no='.$data['no_surat'].'&download=1" title="download yuang">arrow_drop_down_circle</a>
                                $no++;
                              }
                          ?>
                      </tbody>
