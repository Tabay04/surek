        ...
        <div class="col-md-3">
            <div class="card">
              <div class="card-header card-header-tabs card-header-primary">
                ...
                <div class="card-body">
                  <a href="../surat/skbb/skbbpreview.php" target=”_blank”>
        ...
        <div class="col-md-3">
            <div class="card">
              <div class="card-header card-header-tabs card-header-primary">
                ...
                <div class="card-body">
                  <a href="../surat/skmd/skmdpreview.php" target=”_blank”> 
        ...
        <div class="col-md-3">
            <div class="card">
              <div class="card-header card-header-tabs card-header-primary">
                ...
                <div class="card-body">
                  <a href="../surat/sktm/sktmpreview.php" target=”_blank”>
        ...
        <div class="col-md-3">
            <div class="card">
              <div class="card-header card-header-tabs card-header-primary">
                ...
                <div class="card-body">
                  <a href="../surat/sku/skupreview.php" target=”_blank”>
