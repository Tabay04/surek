            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-header card-header-primary">
                  <h4 class="card-title">SKMD</h4>
                  <p class="card-category">Surat Keterangan Meninggal Dunia</p>
                </div>
                </center>
                <div class="card-body">
                      ...
                      <table  class="table table-bordered" style="width:100%">
                        ...
                        <tbody>
                          <?php
                            ...
                            $sql=pg_query("SELECT S.no_surat, S.hubungan, S.tanggal, S.status, PG.nama_pegawai, PG.jabatan, P.nik, P.no_kk, P.nama_lengkap, P.jenis_kelamin, P.tempat_lahir, P.tanggal_lahir, P.nama_lengkap_ibu, P.nama_lengkap_ayah, P.status_kawin, P.gol_darah, P.pendidikan_akhir, P.jenis_pekerjaan, P.status_hubkel, P.tanggal_entri, P.tanggal_ubah, P.agama, R.alamat
                            ...
                            while ($data=pg_fetch_assoc($sql)) {
                                ...
                                echo '<td><center> <a class="material-icons" target="_blank" href="../surat/skmd/skmd.php?no='.$data['no_surat'].'">insert_drive_file</a>
                                    
                                 </center></td>';

                                echo "</tr>";
                                // <a class="material-icons" target="_blank" href="../surat/skmd/skmd.php?no='.$data['no_surat'].'&download=1" title="download yuang">arrow_drop_down_circle</a>
                                $no++;
                              }
                          ?>
                      </tbody>
