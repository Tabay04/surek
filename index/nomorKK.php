    ...
    <div class="main-panel">
      ...
      <div class="content">
        <?php
          ...
          echo  "<strong>".$_GET['gagal']."</strong> Gagal Ditambahkan !";
          echo  '<button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
         </div>';
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Tambahkan Nomor KK dengan benar</p>
                </div>
                </center>
                <div class="card-body">
                  <form action="../proses/tambahkk.php" method="POST">
                    <div class="row">
                      <div class="col-md-4">
                      </div>
                      <div class="col-md-4">
                          <div class="form-group">
                            <label class="bmd-label-floating">Nomor KK</label>
                            <input id='no_kk' type="text" name="no_kk" class="form-control" required>
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <select class="selectpicker form-control" id="id_rumah" name="id_rumah" data-container="body" data-live-search="true"  data-hide-disabled="true">
                          <option value="0">Pilih Kode Rumah</option>
                            <?php          
                                include '../controller/connect.php';      
                                $sql_d=pg_query("SELECT id_rumah, alamat FROM rumah ORDER BY id_rumah");
                                while($row = pg_fetch_assoc($sql_d))
                                {
                                    echo"<option value=".$row['id_rumah'].">(".$row['id_rumah'].") ".$row['alamat']."</option>";
                                }
                            ?>
                        </select>
                      </div>
                  ...
                  <br/>
                      <center>
                        <input class="btn btn-primary btn-round" type="submit" name="tambahkk" value="Tambah">
                        </input>
                      </center>
