...
<head>
  ...
  <script type="text/javascript">
    var server = "http://localhost:8080/surek-master/";
  </script>
</head>
<?php
  include '../controller/connect.php';
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                <form action="../proses/form-sktm.php" method="post">
                   <?php                
                  ...
                  <button class="btn btn-primary" onclick="checkNomor()">Nomor Terakhir</button>
                    <input id="no_surat" type="text" class="form-control" readonly required name="no_surat" value="500 / 00<?php echo $no ?> / SKTM / 2021">

                  <br/>
                  <font>NIK Pembuat:</font>
                  <select onchange="ibu_ayah();" class="selectpicker form-control" id="nik" name="pembuat" data-container="body" data-live-search="true" required title="PILIH NIK PENDUDUK" data-hide-disabled="true">
                        <?php                
                  ...
                  <br/> <br/> <br/>
                  <font>NIK Ibu:</font>
                  <select class="selectpicker form-control" id="ibu" name="nik_ibu" data-container="body" data-live-search="true" required title="PILIH NIK PENDUDUK" data-hide-disabled="true">
                        <?php                
                            $sql_d=pg_query("SELECT nik, nama_lengkap FROM penduduk ORDER BY nama_lengkap");
                            while($row = pg_fetch_assoc($sql_d))
                            {
                  ...
                  <br/><br/><br/>
                  <font>NIK Ayah:</font>
                  <select class="selectpicker form-control" id="ayah" name="nik_ayah" data-container="body" data-live-search="true" required title="PILIH NIK PENDUDUK" data-hide-disabled="true">
                        <?php                
                            $sql_d=pg_query("SELECT nik, nama_lengkap FROM penduduk ORDER BY nama_lengkap");
                            while($row = pg_fetch_assoc($sql_d))
                            {
