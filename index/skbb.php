            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Surat Keterangan Berkelakuan Baik</h4>
                </div>
                </center>
                <div class="card-body">
                <form action="../proses/form-skbb.php" method="post">
                  <font>No. Surat:</font>
                    <input type="text" class="form-control" name="" value="    /RSKB/2019">
                  <br/>
                  <select class="selectpicker form-control" id="nik" name="nik" data-container="body" data-live-search="true" title="PILIH NIK PENDUDUK" data-hide-disabled="true">
