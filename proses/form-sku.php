<?php
	...
	$sql = pg_query("INSERT INTO sku (no_surat, nik, Id_jenis_usaha, tahun_usaha, id_jorong, id_pegawai, status, tanggal) VALUES ('$no_surat', '$nik', '$jeus','$taus','$idjor', '$pegawai', '$status','$tanggal')");
