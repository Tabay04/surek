<?php
	...
	$sql = pg_query("INSERT INTO scustom (no_surat, judul_surat, nik, konten, id_pegawai, status, tanggal) VALUES ('$no_surat', '$judul_surat', '$nik[1]', '$konten', '$pegawai', '$status', '$tanggal')");
